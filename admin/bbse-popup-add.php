...
<div class="wrap">
	<div>
		<iframe src="http://update.onsetheme.com/banner_iframe/BBSe_Popup_banner.php" class="banner_iframe" scrolling="no"></iframe>
	</div>
									...
									<tr id="period-msg-3" style="display:<?php echo ($popupPeriodMsg['0']=='Y')?"table-row":"none";?>;">
										...
										<td class="noneLine">
											<select name='bbse_popup_period_msg_position' id='bbse_popup_period_msg_position' style="width:150px;height:29px;line-height:29px;">
												...
												<option value="Right" <?php echo ($popupPeriodMsg['2']=='Right')?"selected='selected'":"";?>><?php echo __('Right','BBSe_Popup');?></option>
											</select>
										</td>
									</tr>
